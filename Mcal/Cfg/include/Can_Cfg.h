...
*
*/
#define LedStatusRx_0x300  0U /* RECEIVE object of Can Controller ID = 0 */
#define DcmRx_0x703  1U /* RECEIVE object of Can Controller ID = 0 */
#define DcmRx_0x7df  2U /* RECEIVE object of Can Controller ID = 0 */
#define DcmTx_0x70a  3U /* TRANSMIT object of Can Controller ID = 0 */
#define CmdSendTx_0x301  4U /* TRANSMIT object of Can Controller ID = 0 */
#define CanTx_0x70c  5U /* TRANSMIT object of Can Controller ID = 0 */
...
*
*/
#define CAN_MAXFILTERCOUNT_0 3U
...
*/
    ...
    #endif
#else
    #define CAN_TIMEOUT_DURATION 3U

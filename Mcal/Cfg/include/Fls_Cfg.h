...
#define FLS_QSPI_FLASH_AVAILABLE    (STD_ON)
...
#define FLS_QSPI_SYNC_READ_TIMEOUT_VALUE    (0U)
#define FLS_QSPI_SYNC_WRITE_TIMEOUT_VALUE   (0U)
#define FLS_QSPI_SYNC_ERASE_TIMEOUT_VALUE   (0U)
#define FLS_QSPI_ASYNC_WRITE_TIMEOUT_VALUE  (0U)
#define FLS_QSPI_ASYNC_ERASE_TIMEOUT_VALUE  (0U)
#define FLS_QSPI_IRQ_READ_TIMEOUT_VALUE     (0U)
#define FLS_QSPI_IRQ_ERASE_TIMEOUT_VALUE    (0U)
#define FLS_QSPI_IRQ_WRITE_TIMEOUT_VALUE    (0U)
...
#define FLS_QSPI_HYPERFLASH_MODE            (STD_OFF)
...
#define P_FLASH_SIZE        (0x180000U)
#define D_FLASH_SIZE        (0x80000U)

...
LOCAL_INLINE void Eth_RxIrqHdlr (CONST(uint8, AUTOMATIC) u8CtrlIdx)
{
    if(ETH_STATE_ACTIVE != Eth_CtrlState[u8CtrlIdx])
    {
    #if STD_ON == ETH_DEV_ERROR_DETECT
    (void)Det_ReportError ( \
        (VAR(uint8, AUTOMATIC)) ETH_MODULE_ID, \
        ETH_DRIVER_INSTANCE, (VAR(uint8, AUTOMATIC)) ETH_SID_RXIRQHDLR, \
    ...
    else
    {
        ...
        {    
            ...
            {   /* The interrupt flag still must be cleared. */
                /* The interrupt is disabled however the handler has been
                   called. This may happen if the call is invalid or if the
                   interrupt ocurred while global interrupt mask was cleared
...
LOCAL_INLINE void Eth_TxIrqHdlr (CONST(uint8, AUTOMATIC) u8CtrlIdx)
{
    ...
    if(ETH_STATE_ACTIVE != Eth_CtrlState[u8CtrlIdx])
    {
        ...
        (void)Det_ReportError ( \
            (VAR(uint8, AUTOMATIC)) ETH_MODULE_ID, \
            ETH_DRIVER_INSTANCE, (VAR(uint8, AUTOMATIC)) ETH_SID_TXIRQHDLR, \
            ETH_E_NOT_INITIALIZED \
                              );
        #endif /* ETH_DEV_ERROR_DETECT  */
    }
...
*                layers.
* @isr
* @implements    Eth_RxIrqHdlr_0_Activity
* @violates @ref Eth_Irq_c_REF_5 MISRA 2004 Rule 8.10
*/
...
*                transmitted frames are unlocked after the confirmation.
* @isr
* @implements    Eth_TxIrqHdlr_0_Activity
* @violates @ref Eth_Irq_c_REF_5 MISRA 2004 Rule 8.10
*/
ISR(Eth_TxIrqHdlr_0)
{
...
*                about received frames. Received data are passed to the upper
*                layers.
* @implements    Eth_TxRxIrqHdlr_0_Activity
* @violates @ref Eth_Irq_c_REF_5 MISRA 2004 Rule 8.10
*/
...
*                layers.
* @isr
* @implements    Eth_RxIrqHdlr_1_Activity
* @violates @ref Eth_Irq_c_REF_5 MISRA 2004 Rule 8.10
*/
...
*                transmitted frames are unlocked after the confirmation.
* @isr
* @implements    Eth_TxIrqHdlr_1_Activity
* @violates @ref Eth_Irq_c_REF_5 MISRA 2004 Rule 8.10
*/
...
*                about received frames. Received data are passed to the upper
*                layers.
* @implements    Eth_TxRxIrqHdlr_1_Activity
* @violates @ref Eth_Irq_c_REF_5 MISRA 2004 Rule 8.10
*/

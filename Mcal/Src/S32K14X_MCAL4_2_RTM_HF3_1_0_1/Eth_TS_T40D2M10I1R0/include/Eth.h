...
#define ETH_SID_CONTROLLERINIT          0x02
...
#define ETH_SID_RXIRQHDLR               0x10
#define ETH_SID_TXIRQHDLR               0x11
...
extern FUNC(Std_ReturnType, ETH_CODE) Eth_ControllerInit(VAR(uint8, AUTOMATIC) CtrlIdx, VAR(uint8, AUTOMATIC) CfgIdx);

 ...
 *  V2.0.2    [20210123]  [darren.zhang]  Code refactoring ,include code style and tls handle
***********************************************************************************************************************/
#ifndef TCPIP_H_
#define TCPIP_H_
...
#define TCPIP_H_AR_MAJOR_VERSION                    19
#define TCPIP_H_AR_MINOR_VERSION                    11
#define TCPIP_H_AR_PATCH_VERSION                    0
#define TCPIP_H_SW_MAJOR_VERSION                    2
#define TCPIP_H_SW_MINOR_VERSION                    0
#define TCPIP_H_SW_PATCH_VERSION                    2
...
FUNC(Std_ReturnType, TCPIP_CODE) TcpIp_ResetIpAssignment(
    VAR(void, AUTOMATIC)
);

...
typedef struct
{
    P2FUNC(void,SOAD_APPL_CODE,If_RxIndication_FuncPtr)(
            PduIdType RxPduId,
            const PduInfoType* PduInfoPtr);
    P2FUNC(Std_ReturnType,SOAD_APPL_CODE,If_TriggerTransmit_FuncPtr)(
            PduIdType TxPduId,
            PduInfoType* PduInfoPtr);
    P2FUNC(void,SOAD_APPL_CODE,If_TxConfirmation_FuncPtr)(
            PduIdType TxPduId);
    ...
    P2FUNC(BufReq_ReturnType,SOAD_APPL_CODE,Tp_CopyRxData_FuncPtr)(
            ...
            const PduInfoType* info,
            PduLengthType* bufferSizePtr);
    P2FUNC(void,SOAD_APPL_CODE,Tp_RxIndication_FuncPtr)(
            PduIdType RxPduId,
    ...
    P2FUNC(void,SOAD_APPL_CODE,Tp_TxConfirmation_FuncPtr)(
            PduIdType TxPduId,
            Std_ReturnType result);
    P2FUNC(void,SOAD_APPL_CODE,SoConModeChg_FuncPtr)(

...
extern EthIf_ConfigType  EthIf_ConfigData;
/*TODO EthIf_RxIndication*/
extern struct netif g_netif;

extern const EthIf_EthDriverApiType Eth_DriverApi[];
#if (STD_ON == ETHIF_USE_ETHTRCV)
extern const EthIf_EthTrcvDriverApiType EthTrcv_DriverApi[];
#endif /* STD_ON == ETHIF_USE_ETHTRCV */
/*******************************************************************************
**                      Global Symbols                                        **
*******************************************************************************/
/* @req SWS_EthIf_00006 */
#define ETHIF_H_AR_RELEASE_MAJOR_VERSION        (19u)
#define ETHIF_H_AR_RELEASE_MINOR_VERSION        (11u)
#define ETHIF_H_AR_RELEASE_REVISION_VERSION     (0u)

#define ETHIF_H_SW_MAJOR_VERSION                (2u)
#define ETHIF_H_SW_MINOR_VERSION                (0u)
#define ETHIF_H_SW_PATCH_VERSION                (5u)

#define ETHIF_MODULE_ID                         (65u)
#define ETHIF_INSTANCE_ID                       (0u)
#define ETHIF_VENDOR_ID                         (61u)
/*Error IDs*/
...
*******************************************************************************/
/* @req SWS_EthIf_00024 */
FUNC(void, ETHIF_CODE) EthIf_Init( P2CONST(EthIf_ConfigType, ETHIF_APPL_DATA, ETHIF_VAR) CfgPtr );/** Init function for ETHIF */
/* @req SWS_EthIf_00034 */
...
FUNC(Std_ReturnType, Std_ReturnType) EthIf_GetCtrlIdxList( 

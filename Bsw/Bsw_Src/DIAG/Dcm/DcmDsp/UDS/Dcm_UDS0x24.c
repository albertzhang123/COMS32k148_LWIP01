            ...
            if (pDcmDspDidSignal != NULL_PTR)
            {
                ...
                if (E_OK == ret)
                {
                    if (DCM_UINT8_DYN == pDcmDspDidSignal->pDcmDspDidData->DcmDspDataType)
                    {
                        ...
                        if (NULL_PTR == pDcmDspDidSignal->pDcmDspDidData->
                    ...
                    else
                    {
                        ...
                        {
                            DataSize = Dcm_DspCfg.pDcmDspDataInfo[pDcmDspDidSignal->
                             pDcmDspDidData->DcmDspDataInfoIndex].DcmDspDataScalingInfoSize;
                        }
                        else
                        {
                            DataSize = 0;

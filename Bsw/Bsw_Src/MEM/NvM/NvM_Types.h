...
#define NVM_E_WRITE_PROTECTED           (0x1Bu)
 ...
 */
typedef P2FUNC(Std_ReturnType, NVM_APPL_CODE, NvM_InitBlockCallbackType)(void);  /* A pointer to initial callback function.*/
 ...
 *          E_NOT_OK: Callback function has not been processed successfully.
 */
typedef P2FUNC(Std_ReturnType, NVM_APPL_CODE, NvM_SingleBlockCallbackType)(uint8 ServiceId, NvM_RequestResultType JobResult);  /* A pointer to single block callback function.*/
 ...
 *          E_NOT_OK:Callback function has not been processed successfully
 */
typedef P2FUNC(Std_ReturnType, NVM_APPL_CODE, NvM_ReadRamBlockFromNvmCallbackType)(const void* NvMBuffer);  /* A pointer to copy ram to ram mirror callback function.*/
 ...
 *          E_NOT_OK:Callback function has not been processed successfully
 */
typedef P2FUNC(Std_ReturnType, NVM_APPL_CODE, NvM_WriteRamBlockToNvmCallbackType)(void* NvMBuffer);  /* A pointer to copy ram to ram mirror callback function.*/

/*
 * Common callback routine to notify the upper layer that
 * an asynchronous multi block request has been finished.
 */
typedef P2FUNC(void, NVM_APPL_CODE, NvM_MultiBlockCallbackType)(uint8 ServiceId, NvM_RequestResultType JobResult);  /* A pointer to multi block callback function.*/

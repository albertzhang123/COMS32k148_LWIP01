...
#define NVM_H_AR_MINOR_VERSION  2U
#define NVM_H_AR_PATCH_VERSION  2U
...
#define NVM_DET_REPORTERROR(ApiId,ErrorId)     (\
...
(NvM_BlockIdType BlockId, P2VAR(uint8, AUTOMATIC, NVM_APPL_DATA) DataIndexPtr);
...
(NvM_BlockIdType BlockId, void* NvM_DstPtr);
...
(NvM_BlockIdType BlockId, NvM_RequestResultType* RequestResultPtr);

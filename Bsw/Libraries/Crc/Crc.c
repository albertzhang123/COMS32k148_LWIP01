...
#include "Crc_MemMap.h"
static FUNC(uint8, CRC_CODE)
Crc_GetReflection_char(VAR(uint8, AUTOMATIC) input)
{
    uint8 i;
    uint8 result = 0u;
...
#define CRC_START_SEC_CODE
#include "Crc_MemMap.h"
static FUNC(uint32, CRC_CODE)
Crc_GetReflection_int(VAR(uint32, AUTOMATIC) input)
{
    uint32 i;
    uint32 result = 0u;
...
#define CRC_START_SEC_CODE
#include "Crc_MemMap.h"
static FUNC(uint64, CRC_CODE)
Crc_GetReflection_longlong(VAR(uint64, AUTOMATIC) input)
{
    uint64 i;
    uint64 result = 0u;
...
#include "Crc_MemMap.h"
FUNC(uint8, CRC_CODE)
Crc_CalculateCRC8(P2CONST(uint8, AUTOMATIC, CRC_APPL_CONST) Crc_DataPtr,
...
#include "Crc_MemMap.h"
FUNC(uint8, CRC_CODE)
Crc_CalculateCRC8H2F(P2CONST(uint8, AUTOMATIC, CRC_APPL_CONST) Crc_DataPtr,
		          VAR(uint32, AUTOMATIC) Crc_Length,
...
Crc_CalculateCRC16(P2CONST(uint8, AUTOMATIC, CRC_APPL_CONST) Crc_DataPtr,
		          VAR(uint32, AUTOMATIC) Crc_Length,
...
Crc_CalculateCRC32(P2CONST(uint8, AUTOMATIC, CRC_APPL_CONST) Crc_DataPtr,
		          VAR(uint32, AUTOMATIC) Crc_Length,
...
#include "Crc_MemMap.h"
FUNC(uint32, CRC_CODE)
Crc_CalculateCRC32P4(P2CONST(uint8, AUTOMATIC, CRC_APPL_CONST) Crc_DataPtr,
		          VAR(uint32, AUTOMATIC) Crc_Length,
		          VAR(uint32, AUTOMATIC) Crc_StartValue32,
		          VAR(boolean, AUTOMATIC) Crc_IsFirstCall)
{
...
Crc_CalculateCRC64(P2CONST(uint8, AUTOMATIC, CRC_APPL_CONST) Crc_DataPtr,
